...
REM example: mklink /J "S:\Documents\Paradox Interactive\Crusader Kings II\mod\WitcherDev" ".\WitcherDev"
mklink /J "%HOMEDRIVE%%HOMEPATH%\Documents\Paradox Interactive\Crusader Kings II\mod\Witcher Kings" ".\Witcher-Kings"
